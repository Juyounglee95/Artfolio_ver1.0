...
//        );
      //  mediaScanIntent.setDataAndType(contentUri, "image/*");
        Toast.makeText(getImage.this, "Picture Saved", Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            case PICK_FROM_GALLERY:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(getImage.this, "사진찍기를 취소하였습니다.", Toast.LENGTH_SHORT).show();
                }
                break;
...
//                break;
        ...
        switch (requestCode) {
            case MY_PERMISSION_CAMERA:
                for (int i = 0; i < grantResults.length; i++) {
                    ...
                    if (grantResults[i] < 0) {
                        Toast.makeText(getImage.this, "해당 권한을 활성화 하셔야 합니다.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                // 허용했다면 이 부분에서..
    ...
    class picInfo_upload extends AsyncTask<String, Integer, String> {
